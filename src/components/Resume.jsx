    ...
    <section id="resume" className="h-[100%]">
      ...
      <div className="lg:flex block w-[100%] ">
       ...
       <div className="w-[50%] flex flex-col gap-[2rem] flex-1 ">
          <h1 className="inline-block text-[#181818] text-[22px] font-bold leading-[1rem] tracking-[0.5px] p-[20px] self-center border-b border-solid border-yellow-500  relative uppercase " >Experience</h1>
          <VerticalTimeline
          layout={"1-column"}
          lineColor="#ffdd40"
          >
        ...
        <div className="w-[50%] flex flex-col gap-[2rem]">
          <h1 className="inline-block text-[#181818] text-[22px] font-bold leading-[1rem] tracking-[0.5px] p-[20px] self-center border-b border-solid border-yellow-500  relative uppercase ">Education</h1>
          <VerticalTimeline
          layout={"1-column"}
          lineColor="#ffdd40"
          >
